          ...
          <table role="presentation" class="container" cellspacing="0" cellpadding="0" width="100%">
            ...
            <tr>
              <td class="brand-header">
                <span class="brand-badge">Abstract Submission</span>
            ...
            <tr>
              <td class="hero">
                <h2>Abstract Received Successfully</h2>
                <p>Dear <strong>{{ $abstract->presenting_author_name }}</strong>,</p>
                <p style="margin-top: 6px;">Thank you for submitting your abstract for <strong>IPHACON 2027</strong>. Your abstract has been successfully registered in our portal.</p>
              </td>
            </tr>
                  ...
                  <tr>
                    <td class="card-body">
                      <table role="presentation" class="info-table" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          <td class="label">Presenter Category</td>
                          <td class="value">{{ $abstract->presenter_category ?? 'N/A' }}</td>
                        </tr>
                        <tr>
                          <td class="label">Conference Theme</td>
                          <td class="value">{{ $abstract->conference_theme ?? 'N/A' }}</td>
                        </tr>
                        <tr>
                          <td class="label">Presenting Author</td>
                          <td class="value">{{ $abstract->presenting_author_name }}</td>
                        </tr>
                        <tr>
            ...
            <tr>
              <td align="center" style="padding: 0 24px 24px;">
                <a href="{{ url('/login') }}" class="btn" target="_blank">View Submission Portal</a>
              </td>
            </tr>
            ...
            <tr>
              <td class="footer">
                ...
                <div style="margin-top: 12px; font-size: 11px; color: #94a3b8;">
                  If you have any questions regarding abstract submission, please write to us at <strong>iphacon2027@gmail.com</strong>.
                </div>
              </td>
            </tr>
