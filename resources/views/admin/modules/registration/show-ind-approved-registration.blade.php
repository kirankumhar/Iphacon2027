...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex align-items-center justify-content-between py-3 mb-3">
        <h5 class="mb-0"><span class="invert-text-white"><i class="bx bx-check-double me-2 text-success"></i>Indian Approved Registrations</span></h5>
    ...
    <div class="card border-0 shadow-sm rounded-3">
        <div class="card-header bg-white py-3 border-bottom d-flex align-items-center justify-content-between flex-wrap gap-2">
            <h6 class="mb-0 fw-bold text-dark"><i class="bx bx-list-check me-1.5 text-primary"></i>Approved Indian Delegates List</h6>
                            ...
                            <tr>
                                <td colspan="6" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <h6 class="fw-bold text-dark mb-1">No Approved Registrations Yet</h6>
