...
@section('admin-content')
    <div class="container-xxl flex-grow-1 ">
        ...
        <div class="card mb-4">
            <h5 class="card-header text-white bg-info">Scrutiny International Delegates Payment Submitted</h5>
            @if (session('success'))
                ...
                <div class="row d-none">
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="text-center">
                            <input type="button" id="searchButton" value="Search" data-route="pending" class="btn btn-info mt-4">
