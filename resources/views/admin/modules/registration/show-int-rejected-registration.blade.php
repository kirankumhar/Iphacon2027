...
@section('admin-content')
    <div class="container-xxl flex-grow-1 ">
        <h6 class="py-3 mb-4"><span class="invert-text-white">International Delegates/Rejected Delegates </span>
        </h6>

        <div class="card mb-4">
            <h5 class="card-header text-white bg-info">View Rejected Delegates List</h5>
            @if (session('success'))
                ...
                <div class="row d-none">
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="text-center">
                            <input type="button" id="searchButton" value="Search" data-route="reject" class="btn btn-info mt-4">
