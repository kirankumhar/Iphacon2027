...
<div class="container-xxl flex-grow-1 mt-3.5 mb-4">
    <div class="d-flex align-items-center justify-content-between py-2 mb-3">
        <h5 class="mb-0 fw-bold text-dark">
            <i class="bx bx-credit-card me-2 text-success fs-4"></i>Successful Payments
        </h5>
        <span class="badge bg-success text-white rounded-pill px-3.5 py-2 fs-7 fw-bold shadow-xs">
    ...
    <div class="card border-0 shadow-sm rounded-3 overflow-hidden">
        <div class="card-header bg-white py-3 border-bottom d-flex align-items-center justify-content-between flex-wrap gap-2">
            <h6 class="mb-0 fw-bold text-dark"><i class="bx bx-list-check me-1.5 text-primary"></i>Paid Transactions History</h6>
                ...
                <table class="table table-hover align-middle mb-0" id="paidPaymentsTable">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th class="pe-3 py-3 text-end" style="width: 15%;">Receipt</th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td class="pe-3 text-end">
                                    @if($pay->payment_receipt_path)
                                        <a href="{{ asset('storage/' . $pay->payment_receipt_path) }}" target="_blank" class="btn btn-sm btn-outline-success px-3 py-1 rounded-2" style="font-size: 0.75rem;">
                                            <i class="bx bx-receipt me-1"></i> Receipt
                                        </a>
                                    @elseif($pay->registration?->registration_number)
                                        <a href="{{ route('download.receipt', $pay->registration->registration_number) }}" target="_blank" class="btn btn-sm btn-outline-primary px-3 py-1 rounded-2" style="font-size: 0.75rem;">
                            ...
                            <tr>
                                <td colspan="6" class="text-center py-5">
                                    <div class="text-muted">
                                        ...
                                        <p class="mb-0 fw-semibold">No successful payment records found.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
